...
本项目是星火编辑器（SCE）Lua 游戏项目，使用 **[bgd_sce_framework](https://github.com/woaye168/bgd_sce_framework)** 开发，配合构建工具 **[bgd_sce_tools](https://github.com/woaye168/bgd_sce_tools)** 一起使用：
...
框架与游戏代码**彻底分治**：`libs/` 是框架远程仓库下发管理，`src/` 是你的（永远不被框架更新触碰, 初始化提供的游戏代码模板你可以随意更改）。
